    ...
    <div>
      <svg :width="size" :height="size" :view-box.camel="viewBox">
        <g v-for="(o,oi) in a" :transform="t(0,0,r)">
          <path stroke-linecap="round" stroke-linejoin="round" v-for="c in count / 2" :transform="t(0,0,(360 / a) * o)" :d="line([...points,points[0],points[1],points[2]].slice(c * 2,c * 2 + 3))" stroke="var(--color-gray-dark)" fill="var(--color-red)" stroke-width="3" />
        </g>
      </svg>    
    </div>
  `
